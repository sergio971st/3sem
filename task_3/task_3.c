...
int main()
{
  ...
  for (THREAD_QUANTITY = 1; THREAD_QUANTITY < MAX_THREAD_QUANTITY; THREAD_QUANTITY++) {
  ...
  printf("Thread quantity is %d, time is %ld\n", THREAD_QUANTITY, clock2-clock1);
  }
  /*array[0] = under_y;
